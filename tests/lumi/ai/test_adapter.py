...
def test_adapter_uses_structured_parse_and_logs_no_payload(caplog):
    ...
    with caplog.at_level(logging.INFO):
        result = adapter.extract_plan_proposal(payload, ExtractionContext(correlation_id="corr-1"))
...
def test_settings_enable_demo_key_without_storing_it(monkeypatch):
